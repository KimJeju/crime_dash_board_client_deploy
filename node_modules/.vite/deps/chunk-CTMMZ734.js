...
import {
  Paper_default
} from "./chunk-XYRCADQB.js";
import {
  useTheme
} from "./chunk-OU7IYVNI.js";
import {
  Transition_default
} from "./chunk-RPD7EYYY.js";
import {
  useRtl
} from "./chunk-VEDVOACE.js";
import {
  debounce_default,
  init_debounce,
  init_utils as init_utils2,
  ownerWindow_default
} from "./chunk-GYP2XT6J.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-RIQMMP4O.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-F4C32HQC.js";
import {
  HTMLElementType,
  chainPropTypes,
...
var Slide = React6.forwardRef(function Slide2(props, ref) {
  const theme = useTheme();
  const defaultEasing = {
  ...
  const childrenRef = React6.useRef(null);
...
var Drawer = React7.forwardRef(function Drawer2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDrawer"
  });
  ...
  const drawer = (0, import_jsx_runtime8.jsx)(DrawerPaper, _extends({
  ...
  if (variant === "permanent") {
    return (0, import_jsx_runtime8.jsx)(DrawerDockedRoot, _extends({
  ...
  const slidingDrawer = (0, import_jsx_runtime8.jsx)(TransitionComponent, _extends({
    in: open,
  ...
  return (0, import_jsx_runtime8.jsx)(DrawerRoot, _extends({
...
//# sourceMappingURL=chunk-CTMMZ734.js.map
