...
import {
  contains,
  useWindow
} from "./chunk-O5W3YEWG.js";
import {
  NavContext_default,
  NavLink_default,
  useForceUpdate
} from "./chunk-2XDEX33P.js";
import {
  Anchor_default,
  Button_default,
  useButtonProps,
  useCallbackRef,
  useEventListener
} from "./chunk-IA6CJS2G.js";
import {
  NavbarContext_default,
  dataAttr,
  qsa
} from "./chunk-QJQ7B5WC.js";
import {
  require_browser,
  ...
  usePrevious,
  useUncontrolled
} from "./chunk-5ACW7FJG.js";
import {
  $b5e257d569688ac6$export$619500959fc48b26,
  useUncontrolledProp
} from "./chunk-SLNEE7BV.js";
import "./chunk-V5VXRHLU.js";
import {
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react5.useContext)(DropdownContext_default) || {};
...
function useDropdownItem({
  ...
  const navContext = (0, import_react6.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react7.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react7.useRef)(null);
  const focusInDropdown = (0, import_react7.useRef)(false);
  const onSelectCtx = (0, import_react7.useContext)(SelectableContext_default);
  const toggle = (0, import_react7.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context2 = (0, import_react7.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react7.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false)
    return ref;
  const warningRef = (0, import_react8.useCallback)((refValue) => {
...
var DropdownMenu2 = React12.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react9.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react9.useContext)(DropdownContext_default2);
  align = align || contextAlign;
  const isInputGroup = (0, import_react9.useContext)(InputGroupContext_default);
  const alignClasses = [];
  if (align) {
...
var DropdownToggle2 = React14.forwardRef(({
  ...
  const dropdownContext = (0, import_react10.useContext)(DropdownContext_default);
