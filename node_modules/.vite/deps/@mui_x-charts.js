...
import "./chunk-KOEJCCPR.js";
import "./chunk-7FMKGLPC.js";
import "./chunk-PW575AK2.js";
import "./chunk-BBCGUJBV.js";
import {
  useTheme
} from "./chunk-OU7IYVNI.js";
import {
  useSlotProps
} from "./chunk-6RX4J3WH.js";
import "./chunk-3GS3N7PG.js";
import "./chunk-VEDVOACE.js";
import "./chunk-JHJOBDZT.js";
import "./chunk-RIQMMP4O.js";
import {
  ...
  useForkRef,
  useId
} from "./chunk-W23KULTJ.js";
import {
  styled_default
} from "./chunk-RW7KUJKQ.js";
import {
  composeClasses,
...
function LineHighlightPlot(props) {
  ...
  const seriesData = React15.useContext(SeriesContext).line;
...
var LineChart = React16.forwardRef(function LineChart2(props, ref) {
  ...
  return (0, import_jsx_runtime15.jsxs)(ResponsiveChartContainer, {
    ...
    children: [onAxisClick && (0, import_jsx_runtime15.jsx)(ChartsOnAxisClickHandler, {
      onAxisClick
    }), grid && (0, import_jsx_runtime15.jsx)(ChartsGrid, {
      vertical: grid.vertical,
      horizontal: grid.horizontal
    }), (0, import_jsx_runtime15.jsxs)("g", {
      clipPath: `url(#${clipPathId})`,
      children: [(0, import_jsx_runtime15.jsx)(AreaPlot, {
        slots,
        slotProps,
        onItemClick: onAreaClick,
        skipAnimation
      }), (0, import_jsx_runtime15.jsx)(LinePlot, {
        slots,
        slotProps,
        onItemClick: onLineClick,
        skipAnimation
      }), (0, import_jsx_runtime15.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime15.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime15.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), (0, import_jsx_runtime15.jsx)(MarkPlot, {
      slots,
      slotProps,
      onItemClick: onMarkClick,
      skipAnimation
    }), (0, import_jsx_runtime15.jsx)(LineHighlightPlot, {
      slots,
      slotProps
    }), (0, import_jsx_runtime15.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), !loading && (0, import_jsx_runtime15.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), (0, import_jsx_runtime15.jsx)(ChartsClipPath, {
      id: clipPathId
    }), children]
  });
});
...
var _excluded11 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "highlightScope", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle"];
...
function useTransformData(series) {
  ...
  const getHighlightStatus = React18.useCallback((dataIndex) => {
...
var _excluded12 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlightScope", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
var _excluded14 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "highlightScope", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
true ? PieArcLabelPlot.propTypes = {
  ...
  highlightScope: import_prop_types17.default.shape({
    faded: import_prop_types17.default.oneOf(["global", "none", "series"]),
    highlighted: import_prop_types17.default.oneOf(["item", "none", "series"])
  }),
  id: import_prop_types17.default.oneOfType([import_prop_types17.default.number, import_prop_types17.default.string]).isRequired,
  /**
   * The radius between circle center and the beginning of the arc.
...
function PiePlot(props) {
  ...
  const seriesData = React22.useContext(SeriesContext).pie;
  const {
    left,
    top,
    width,
...
function Scatter(props) {
  ...
  const highlightScope = React24.useMemo(() => _extends({
    highlighted: "item",
    faded: "global"
...
function ScatterPlot(props) {
  ...
  const seriesData = React25.useContext(SeriesContext).scatter;
  const axisData = React25.useContext(CartesianContext);
  const {
    zAxis,
    zAxisIds
  ...
  return (0, import_jsx_runtime23.jsx)(React25.Fragment, {
    children: seriesOrder.map((seriesId) => {
      ...
      const colorGetter = getColor2(series[seriesId], xAxis[xAxisKey ?? defaultXAxisId], yAxis[yAxisKey ?? defaultYAxisId], zAxis[zAxisKey ?? defaultZAxisId]);
      const xScale = xAxis[xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisKey ?? defaultYAxisId].scale;
...
var ScatterChart = React26.forwardRef(function ScatterChart2(props, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(ResponsiveChartContainer, {
    ref,
    series: series.map((s) => _extends({
      type: "scatter"
    }, s)),
    ...
    yAxis,
    sx,
    children: (0, import_jsx_runtime24.jsxs)(ZAxisContextProvider, {
      zAxis,
      children: [!disableVoronoi && (0, import_jsx_runtime24.jsx)(ChartsVoronoiHandler, {
        voronoiMaxRadius,
        onItemClick
      }), (0, import_jsx_runtime24.jsx)(ChartsAxis, {
        topAxis,
        leftAxis,
        rightAxis,
        bottomAxis,
        slots,
        slotProps
      }), grid && (0, import_jsx_runtime24.jsx)(ChartsGrid, {
        vertical: grid.vertical,
        horizontal: grid.horizontal
      }), (0, import_jsx_runtime24.jsx)(ScatterPlot, {
        slots,
        slotProps,
        onItemClick: disableVoronoi ? onItemClick : void 0
      }), (0, import_jsx_runtime24.jsx)(ChartsOverlay, {
        loading,
        slots,
        slotProps
      }), (0, import_jsx_runtime24.jsx)(ChartsLegend, _extends({}, legend, {
        slots,
        slotProps
      })), (0, import_jsx_runtime24.jsx)(ChartsAxisHighlight, _extends({
        x: "none",
        y: "none"
      }, axisHighlight)), !loading && (0, import_jsx_runtime24.jsx)(ChartsTooltip, _extends({
        trigger: "item"
      }, tooltip)), children]
    })
  });
...
true ? ScatterChart.propTypes = {
  ...
  xAxis: import_prop_types22.default.arrayOf(import_prop_types22.default.shape({
    ...
    max: import_prop_types22.default.oneOfType([import_prop_types22.default.instanceOf(Date), import_prop_types22.default.number]),
    min: import_prop_types22.default.oneOfType([import_prop_types22.default.instanceOf(Date), import_prop_types22.default.number]),
    position: import_prop_types22.default.oneOf(["bottom", "left", "right", "top"]),
...
true ? SparkLineChart.propTypes = {
  ...
  xAxis: import_prop_types23.default.shape({
    ...
    max: import_prop_types23.default.oneOfType([import_prop_types23.default.instanceOf(Date), import_prop_types23.default.number]),
    min: import_prop_types23.default.oneOfType([import_prop_types23.default.instanceOf(Date), import_prop_types23.default.number]),
    position: import_prop_types23.default.oneOf(["bottom", "left", "right", "top"]),
