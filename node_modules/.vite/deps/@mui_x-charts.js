...
import "./chunk-PNURAIDV.js";
import "./chunk-YDUXECEX.js";
import {
  useSlotProps
} from "./chunk-NMXVP3SY.js";
import "./chunk-V2PSWLIE.js";
import {
  useTheme
} from "./chunk-5FPMLQ6X.js";
import "./chunk-6VWAHX6D.js";
import "./chunk-D4TSFVOC.js";
import "./chunk-RDG3BE5X.js";
import "./chunk-Q2TVENW2.js";
import {
...
var valueError = buildWarning((value, id) => `MUI X Charts: the value ${value} does not exist in the data of x axis with id ${id}.`, "error");
...
var valueError2 = buildWarning((value, id) => `MUI X Charts: the value ${value} does not exist in the data of y axis with id ${id}.`, "error");
...
var useAnimatedPath = (path, skipAnimation) => {
  ...
  const interpolator = React5.useMemo(() => previousPath ? string_default(previousPath, path) : () => path, [previousPath, path]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime5.jsxs)(React6.Fragment, {
    children: [(0, import_jsx_runtime5.jsx)("clipPath", {
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime5.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path
      }))
    })]
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(React9.Fragment, {
    children: [(0, import_jsx_runtime8.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime8.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top + height + bottom
      })
    }), (0, import_jsx_runtime8.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime8.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path
      }))
    })]
...
function LineHighlightElement(props) {
  ...
  return (0, import_jsx_runtime13.jsx)(HighlightElement, _extends({
    pointerEvents: "none",
    ownerState,
    className: classes.root,
    cx: 0,
...
function LineHighlightPlot(props) {
  ...
  return (0, import_jsx_runtime14.jsx)("g", _extends({}, other, {
    children: stackingGroups.flatMap(({
      ids: groupIds
    }) => {
      return groupIds.flatMap((seriesId) => {
...
var LineChart = React16.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime15.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime15.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime15.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime15.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime15.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime15.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime15.jsx)(ChartsOverlay, _extends({}, overlayProps))]
    })), (0, import_jsx_runtime15.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime15.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), (0, import_jsx_runtime15.jsx)(MarkPlot, _extends({}, markPlotProps)), (0, import_jsx_runtime15.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime15.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime15.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime15.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
...
var _excluded11 = ["classes", "color", "cornerRadius", "dataIndex", "endAngle", "id", "innerRadius", "isFaded", "isHighlighted", "onClick", "outerRadius", "paddingAngle", "startAngle", "highlightScope"];
...
function PieArc(props) {
  ...
  const getInteractionItemProps = useInteractionItemProps();
  return (0, import_jsx_runtime16.jsx)(PieArcRoot, _extends({
...
true ? PieArc.propTypes = {
  ...
  highlightScope: import_prop_types14.default.shape({
    fade: import_prop_types14.default.oneOf(["global", "none", "series"]),
    faded: import_prop_types14.default.oneOf(["global", "none", "series"]),
    highlight: import_prop_types14.default.oneOf(["item", "none", "series"]),
...
function useTransformData(series) {
  ...
  const dataWithHighlight = React18.useMemo(() => data.map((item, itemIndex) => {
    const currentItem = {
      seriesId,
      dataIndex: itemIndex
    };
...
var _excluded12 = ["slots", "slotProps", "innerRadius", "outerRadius", "cornerRadius", "paddingAngle", "id", "highlighted", "faded", "data", "onItemClick", "skipAnimation"];
...
function PieArcPlot(props) {
  ...
  return (0, import_jsx_runtime17.jsx)("g", _extends({}, other, {
    children: transition((_ref, item, _, index) => {
      ...
      return (0, import_jsx_runtime17.jsx)(Arc, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
var _excluded13 = ["id", "classes", "color", "startAngle", "endAngle", "paddingAngle", "arcLabelRadius", "innerRadius", "outerRadius", "cornerRadius", "formattedArcLabel", "isHighlighted", "isFaded", "style"];
...
function PieArcLabel(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(PieArcLabelRoot, _extends({
    className: classes.root
  }, other, {
    style: _extends({
...
true ? PieArcLabel.propTypes = {
  ...
  formattedArcLabel: import_prop_types16.default.string,
...
var _excluded14 = ["arcLabel", "arcLabelMinAngle", "arcLabelRadius", "cornerRadius", "data", "faded", "highlighted", "id", "innerRadius", "outerRadius", "paddingAngle", "skipAnimation", "slotProps", "slots"];
...
function PieArcLabelPlot(props) {
  ...
  return (0, import_jsx_runtime19.jsx)("g", _extends({}, other, {
    children: transition((_ref, item) => {
      ...
      return (0, import_jsx_runtime19.jsx)(ArcLabel, _extends({
        startAngle,
        endAngle,
        paddingAngle: pA,
        innerRadius: iR,
...
true ? PieArcLabelPlot.propTypes = {
   ...
   */
  arcLabel: import_prop_types17.default.oneOfType([import_prop_types17.default.oneOf(["formattedValue", "label", "value"]), import_prop_types17.default.func]),
  /**
   * The minimal angle required to display the arc label.
   * @default 0
   */
  arcLabelMinAngle: import_prop_types17.default.number,
  /**
   * The radius between circle center and the arc label in px.
   * @default (innerRadius - outerRadius) / 2
   */
...
function PiePlot(props) {
  ...
  return (0, import_jsx_runtime20.jsxs)("g", {
    children: [seriesOrder.map((seriesId) => {
      ...
      return (0, import_jsx_runtime20.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime20.jsx)(PieArcPlot, {
          innerRadius,
          outerRadius,
          cornerRadius,
          paddingAngle,
      ...
      return (0, import_jsx_runtime20.jsx)("g", {
        transform: `translate(${left + cx}, ${top + cy})`,
        children: (0, import_jsx_runtime20.jsx)(PieArcLabelPlot, {
          innerRadius,
...
function PieChart(props) {
  ...
  return (0, import_jsx_runtime21.jsxs)(ResponsiveChartContainer, {
    ...
    highlightedItem,
    onHighlightChange,
    children: [(0, import_jsx_runtime21.jsx)(ChartsAxis, {
      topAxis,
      leftAxis,
      rightAxis,
      bottomAxis,
      slots,
      slotProps
    }), (0, import_jsx_runtime21.jsx)(PiePlot, {
      slots,
      slotProps,
      onItemClick,
      skipAnimation
    }), (0, import_jsx_runtime21.jsx)(ChartsOverlay, {
      loading,
      slots,
      slotProps
    }), (0, import_jsx_runtime21.jsx)(ChartsLegend, _extends({}, legend, {
      slots,
      slotProps
    })), (0, import_jsx_runtime21.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), !loading && (0, import_jsx_runtime21.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slots,
      slotProps
    })), children]
  });
...
true ? PieChart.propTypes = {
   ...
   * @default null
   */
  bottomAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.object, import_prop_types19.default.string]),
   ...
   * @default null
   */
  leftAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.object, import_prop_types19.default.string]),
  /**
   ...
   * @default null
   */
  rightAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.object, import_prop_types19.default.string]),
  /**
   ...
   * @default null
   */
  topAxis: import_prop_types19.default.oneOfType([import_prop_types19.default.object, import_prop_types19.default.string]),
...
function Scatter(props) {
  ...
  const cleanData = React24.useMemo(() => {
    const getXPosition = getValueToPositionMapper(xScale);
    const getYPosition = getValueToPositionMapper(yScale);
    const yRange = yScale.range();
    ...
    return temp;
  }, [xScale, yScale, left, width, series.data, series.id, isHighlighted, isFaded, getInteractionItemProps, colorGetter, color2]);
  return (0, import_jsx_runtime22.jsx)("g", {
    children: cleanData.map((dataPoint) => (0, import_jsx_runtime22.jsx)("circle", _extends({
      cx: 0,
      cy: 0,
...
true ? Scatter.propTypes = {
  ...
  colorGetter: import_prop_types20.default.func,
  markerSize: import_prop_types20.default.number.isRequired,
  /**
   * Callback fired when clicking on a scatter item.
  ...
  series: import_prop_types20.default.object.isRequired,
  xScale: import_prop_types20.default.func.isRequired,
  yScale: import_prop_types20.default.func.isRequired
} : void 0;
...
function ScatterPlot(props) {
  ...
  return (0, import_jsx_runtime23.jsx)(React25.Fragment, {
    children: seriesOrder.map((seriesId) => {
      const {
        id,
        xAxisKey,
      ...
      const xScale = xAxis[xAxisKey ?? defaultXAxisId].scale;
      const yScale = yAxis[yAxisKey ?? defaultYAxisId].scale;
      return (0, import_jsx_runtime23.jsx)(ScatterItems, _extends({
        xScale,
        yScale,
        color: color2,
        colorGetter,
...
var ScatterChart = React26.forwardRef(function ScatterChart2(props, ref) {
  const {
    chartContainerProps,
    zAxisProps,
    voronoiHandlerProps,
  ...
  return (0, import_jsx_runtime24.jsx)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: (0, import_jsx_runtime24.jsxs)(ZAxisContextProvider, _extends({}, zAxisProps, {
      children: [!props.disableVoronoi && (0, import_jsx_runtime24.jsx)(ChartsVoronoiHandler, _extends({}, voronoiHandlerProps)), (0, import_jsx_runtime24.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), props.grid && (0, import_jsx_runtime24.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime24.jsx)(ScatterPlot, _extends({}, scatterPlotProps)), (0, import_jsx_runtime24.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime24.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime24.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), !props.loading && (0, import_jsx_runtime24.jsx)(ChartsTooltip, _extends({}, tooltipProps)), children]
    }))
  }));
});
true ? ScatterChart.propTypes = {
   ...
   * @default false
   */
  disableVoronoi: import_prop_types22.default.bool,
  /**
   * Option to display a cartesian grid in the background.
   */
   ...
   * If `undefined`, the radius is assumed to be infinite.
   */
  voronoiMaxRadius: import_prop_types22.default.number,
  /**
   * The width of the chart in px. If not defined, it takes the width of the parent element.
   */
  width: import_prop_types22.default.number,
...
var SparkLineChart = React27.forwardRef(function SparkLineChart2(props, ref) {
  ...
  return (0, import_jsx_runtime25.jsxs)(ResponsiveChartContainer, {
    ref,
    series: [_extends({
      type: plotType,
      data,
    ...
    children: [plotType === "bar" && (0, import_jsx_runtime25.jsx)(BarPlot, {
      skipAnimation: true,
      slots,
      slotProps,
      sx: {
    ...
    }), plotType === "line" && (0, import_jsx_runtime25.jsxs)(React27.Fragment, {
      children: [(0, import_jsx_runtime25.jsx)(AreaPlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime25.jsx)(LinePlot, {
        skipAnimation: true,
        slots,
        slotProps
      }), (0, import_jsx_runtime25.jsx)(LineHighlightPlot, {
        slots,
        slotProps
      })]
    }), (0, import_jsx_runtime25.jsx)(ChartsAxisHighlight, _extends({}, axisHighlight)), showTooltip && (0, import_jsx_runtime25.jsx)(ChartsTooltip, _extends({}, tooltip, {
      slotProps,
      slots
    })), children]
  });
...
true ? SparkLineChart.propTypes = {
   ...
   * @default false
   */
  area: import_prop_types23.default.bool,
   ...
   * @default 'linear'
   */
  curve: import_prop_types23.default.oneOf(["catmullRom", "linear", "monotoneX", "monotoneY", "natural", "step", "stepAfter", "stepBefore"]),
  /**
   * Data to plot.
   */
  data: import_prop_types23.default.arrayOf(import_prop_types23.default.number).isRequired,
  /**
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
   ...
   * @default 'line'
   */
  plotType: import_prop_types23.default.oneOf(["bar", "line"]),
  /**
   ...
   * @default false
   */
  showHighlight: import_prop_types23.default.bool,
  /**
   * Set to `true` to enable the tooltip in the sparkline.
   * @default false
   */
  showTooltip: import_prop_types23.default.bool,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   */
  xAxis: import_prop_types23.default.shape({
   ...
   * Notice it is a single [[AxisConfig]] object, not an array of configuration.
   */
  yAxis: import_prop_types23.default.shape({
    axisId: import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]),
    classes: import_prop_types23.default.object,
    colorMap: import_prop_types23.default.oneOfType([import_prop_types23.default.shape({
      colors: import_prop_types23.default.arrayOf(import_prop_types23.default.string).isRequired,
...
var GaugeContainer = React29.forwardRef(function GaugeContainer2(props, ref) {
  ...
  const svgRef = React29.useRef(null);
  const handleRef = useForkRef(ref, svgRef);
  return (0, import_jsx_runtime27.jsx)(ResizableContainer, _extends({
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    ...
    children: width && height ? (0, import_jsx_runtime27.jsx)(DrawingProvider, {
      width,
      height,
      margin: _extends({
        left: 10,
      ...
      children: (0, import_jsx_runtime27.jsx)(GaugeProvider, {
        ...
        cx,
        cy,
        children: (0, import_jsx_runtime27.jsx)(ChartsSurface, {
          width,
          height,
          ref: handleRef,
          title,
...
function GaugeValueArc(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(StyledPath, _extends({
...
function GaugeValueText(props) {
  ...
  return (0, import_jsx_runtime30.jsx)("g", {
    className,
    children: (0, import_jsx_runtime30.jsx)(ChartsText, _extends({
      x: cx,
      y: cy,
      text: formattedText,
      style: {
...
true ? GaugeValueText.propTypes = {
   ...
   */
  lineHeight: import_prop_types25.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types25.default.bool,
...
var _excluded17 = ["text", "children", "classes"];
...
function Gauge(props) {
  ...
  return (0, import_jsx_runtime31.jsxs)(GaugeContainer, _extends({}, other, {
    className: classes.root,
    children: [(0, import_jsx_runtime31.jsx)(GaugeReferenceArc, {
      className: classes.referenceArc
    }), (0, import_jsx_runtime31.jsx)(GaugeValueArc, {
      className: classes.valueArc
    }), (0, import_jsx_runtime31.jsx)(GaugeValueText, {
...
true ? Gauge.propTypes = {
  ...
  text: import_prop_types26.default.oneOfType([import_prop_types26.default.func, import_prop_types26.default.string]),
