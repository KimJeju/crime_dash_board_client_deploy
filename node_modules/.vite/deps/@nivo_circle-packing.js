...
function v() {
  return v = Object.assign ? Object.assign.bind() : function(t4) {
    for (var i4 = 1; i4 < arguments.length; i4++) {
      var o4 = arguments[i4];
      for (var n4 in o4)
        Object.prototype.hasOwnProperty.call(o4, n4) && (t4[n4] = o4[n4]);
    }
    return t4;
  }, v.apply(this, arguments);
}
var x = { pointerEvents: "none", position: "absolute", zIndex: 10, top: 0, left: 0 };
var m = function(t4, i4) {
  return "translate(" + t4 + "px, " + i4 + "px)";
};
var b = (0, import_react.memo)(function(t4) {
  var o4, n4 = t4.position, r4 = t4.anchor, e6 = t4.children, l4 = zt(), d2 = Ur(), y3 = d2.animate, f2 = d2.config, b2 = kt(), g3 = b2[0], w2 = b2[1], T3 = (0, import_react.useRef)(false), C3 = void 0, E3 = false, P3 = w2.width > 0 && w2.height > 0, j3 = Math.round(n4[0]), N3 = Math.round(n4[1]);
  P3 && ("top" === r4 ? (j3 -= w2.width / 2, N3 -= w2.height + 14) : "right" === r4 ? (j3 += 14, N3 -= w2.height / 2) : "bottom" === r4 ? (j3 -= w2.width / 2, N3 += 14) : "left" === r4 ? (j3 -= w2.width + 14, N3 -= w2.height / 2) : "center" === r4 && (j3 -= w2.width / 2, N3 -= w2.height / 2), C3 = { transform: m(j3, N3) }, T3.current || (E3 = true), T3.current = [j3, N3]);
  var O4 = useSpring({ to: C3, config: f2, immediate: !y3 || E3 }), V3 = v({}, x, l4.tooltip.wrapper, { transform: null != (o4 = O4.transform) ? o4 : m(j3, N3), opacity: O4.transform ? 1 : 0 });
  return (0, import_jsx_runtime.jsx)(animated.div, { ref: g3, style: V3, children: e6 });
});
b.displayName = "TooltipWrapper";
var g = (0, import_react.memo)(function(t4) {
  var i4 = t4.size, o4 = void 0 === i4 ? 12 : i4, n4 = t4.color, r4 = t4.style;
  return (0, import_jsx_runtime.jsx)("span", { style: v({ display: "block", width: o4, height: o4, background: n4 }, void 0 === r4 ? {} : r4) });
});
var w = (0, import_react.memo)(function(t4) {
  var i4, o4 = t4.id, n4 = t4.value, r4 = t4.format, e6 = t4.enableChip, l4 = void 0 !== e6 && e6, a2 = t4.color, c4 = t4.renderContent, h = zt(), u2 = Ot(r4);
  if ("function" == typeof c4)
    i4 = c4();
  else {
    var f2 = n4;
    void 0 !== u2 && void 0 !== f2 && (f2 = u2(f2)), i4 = (0, import_jsx_runtime.jsxs)("div", { style: h.tooltip.basic, children: [l4 && (0, import_jsx_runtime.jsx)(g, { color: a2, style: h.tooltip.chip }), void 0 !== f2 ? (0, import_jsx_runtime.jsxs)("span", { children: [o4, ": ", (0, import_jsx_runtime.jsx)("strong", { children: "" + f2 })] }) : o4] });
  }
  return (0, import_jsx_runtime.jsx)("div", { style: h.tooltip.container, children: i4 });
});
var T = { width: "100%", borderCollapse: "collapse" };
var C = (0, import_react.memo)(function(t4) {
  var i4, o4 = t4.title, n4 = t4.rows, r4 = void 0 === n4 ? [] : n4, e6 = t4.renderContent, l4 = zt();
  return r4.length ? (i4 = "function" == typeof e6 ? e6() : (0, import_jsx_runtime.jsxs)("div", { children: [o4 && o4, (0, import_jsx_runtime.jsx)("table", { style: v({}, T, l4.tooltip.table), children: (0, import_jsx_runtime.jsx)("tbody", { children: r4.map(function(t5, i5) {
    return (0, import_jsx_runtime.jsx)("tr", { children: t5.map(function(t6, i6) {
      return (0, import_jsx_runtime.jsx)("td", { style: l4.tooltip.tableCell, children: t6 }, i6);
    }) }, i5);
  }) }) })] }), (0, import_jsx_runtime.jsx)("div", { style: l4.tooltip.container, children: i4 })) : null;
});
C.displayName = "TableTooltip";
var E = (0, import_react.memo)(function(t4) {
  var i4 = t4.x0, n4 = t4.x1, r4 = t4.y0, e6 = t4.y1, l4 = zt(), u2 = Ur(), d2 = u2.animate, y3 = u2.config, f2 = (0, import_react.useMemo)(function() {
    return v({}, l4.crosshair.line, { pointerEvents: "none" });
  }, [l4.crosshair.line]), x2 = useSpring({ x1: i4, x2: n4, y1: r4, y2: e6, config: y3, immediate: !d2 });
  return (0, import_jsx_runtime.jsx)(animated.line, v({}, x2, { fill: "none", style: f2 }));
});
E.displayName = "CrosshairLine";
var P = (0, import_react.memo)(function(t4) {
  var i4, o4, n4 = t4.width, r4 = t4.height, e6 = t4.type, l4 = t4.x, a2 = t4.y;
  return "cross" === e6 ? (i4 = { x0: l4, x1: l4, y0: 0, y1: r4 }, o4 = { x0: 0, x1: n4, y0: a2, y1: a2 }) : "top-left" === e6 ? (i4 = { x0: l4, x1: l4, y0: 0, y1: a2 }, o4 = { x0: 0, x1: l4, y0: a2, y1: a2 }) : "top" === e6 ? i4 = { x0: l4, x1: l4, y0: 0, y1: a2 } : "top-right" === e6 ? (i4 = { x0: l4, x1: l4, y0: 0, y1: a2 }, o4 = { x0: l4, x1: n4, y0: a2, y1: a2 }) : "right" === e6 ? o4 = { x0: l4, x1: n4, y0: a2, y1: a2 } : "bottom-right" === e6 ? (i4 = { x0: l4, x1: l4, y0: a2, y1: r4 }, o4 = { x0: l4, x1: n4, y0: a2, y1: a2 }) : "bottom" === e6 ? i4 = { x0: l4, x1: l4, y0: a2, y1: r4 } : "bottom-left" === e6 ? (i4 = { x0: l4, x1: l4, y0: a2, y1: r4 }, o4 = { x0: 0, x1: l4, y0: a2, y1: a2 }) : "left" === e6 ? o4 = { x0: 0, x1: l4, y0: a2, y1: a2 } : "x" === e6 ? i4 = { x0: l4, x1: l4, y0: 0, y1: r4 } : "y" === e6 && (o4 = { x0: 0, x1: n4, y0: a2, y1: a2 }), (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [i4 && (0, import_jsx_runtime.jsx)(E, { x0: i4.x0, x1: i4.x1, y0: i4.y0, y1: i4.y1 }), o4 && (0, import_jsx_runtime.jsx)(E, { x0: o4.x0, x1: o4.x1, y0: o4.y0, y1: o4.y1 })] });
});
...
var V = function(t4) {
  var i4 = (0, import_react.useState)(N), n4 = i4[0], l4 = i4[1], a2 = (0, import_react.useCallback)(function(t5, i5, o4) {
    var n5 = i5[0], r4 = i5[1];
    void 0 === o4 && (o4 = "top"), l4({ isVisible: true, position: [n5, r4], anchor: o4, content: t5 });
  }, [l4]), c4 = (0, import_react.useCallback)(function(i5, o4, n5) {
    void 0 === n5 && (n5 = "top");
    var r4 = t4.current.getBoundingClientRect(), e6 = t4.current.offsetWidth, a3 = e6 === r4.width ? 1 : e6 / r4.width, c5 = "touches" in o4 ? o4.touches[0] : o4, s3 = c5.clientX, h = c5.clientY, u2 = (s3 - r4.left) * a3, d2 = (h - r4.top) * a3;
    "left" !== n5 && "right" !== n5 || (n5 = u2 < r4.width / 2 ? "right" : "left"), l4({ isVisible: true, position: [u2, d2], anchor: n5, content: i5 });
  }, [t4, l4]), s2 = (0, import_react.useCallback)(function() {
    l4(N);
  }, [l4]);
  return { actions: (0, import_react.useMemo)(function() {
    return { showTooltipAt: a2, showTooltipFromEvent: c4, hideTooltip: s2 };
  }, [a2, c4, s2]), state: n4 };
};
var k = function() {
  var t4 = (0, import_react.useContext)(j);
  if (void 0 === t4)
    throw new Error("useTooltip must be used within a TooltipProvider");
  return t4;
};
var z = function() {
  var t4 = (0, import_react.useContext)(O);
  if (void 0 === t4)
...
var F = function() {
  var t4 = z();
  return A(t4) ? (0, import_jsx_runtime.jsx)(b, { position: t4.position, anchor: t4.anchor, children: t4.content }) : null;
};
var M = function(t4) {
  var i4 = t4.container, o4 = t4.children, n4 = V(i4), r4 = n4.actions, e6 = n4.state;
  return (0, import_jsx_runtime.jsx)(j.Provider, { value: r4, children: (0, import_jsx_runtime.jsx)(O.Provider, { value: e6, children: o4 }) });
};
...
function colors_default(specifier) {
  var n4 = specifier.length / 6 | 0, colors = new Array(n4), i4 = 0;
  while (i4 < n4)
...
function ramp(range) {
  var n4 = range.length;
  return function(t4) {
    return range[Math.max(0, Math.min(n4 - 1, Math.floor(t4 * n4)))];
  };
}
...
function formatDecimalParts(x2, p2) {
  if ((i4 = (x2 = p2 ? x2.toExponential(p2 - 1) : x2.toExponential()).indexOf("e")) < 0)
    return null;
  var i4, coefficient = x2.slice(0, i4);
  return [
...
function formatGroup_default(grouping, thousands) {
  return function(value, width) {
    var i4 = value.length, t4 = [], j3 = 0, g3 = grouping[0], length = 0;
    while (i4 > 0 && g3 > 0) {
...
function formatTrim_default(s2) {
  out:
    for (var n4 = s2.length, i4 = 1, i0 = -1, i1; i4 < n4; ++i4) {
      switch (s2[i4]) {
        case ".":
          i0 = i1 = i4;
          break;
...
function formatPrefixAuto_default(x2, p2) {
  ...
  if (!d2)
    return x2 + "";
  var coefficient = d2[0], exponent = d2[1], i4 = exponent - (prefixExponent = Math.max(-8, Math.min(8, Math.floor(exponent / 3))) * 3) + 1, n4 = coefficient.length;
  return i4 === n4 ? coefficient : i4 > n4 ? coefficient + new Array(i4 - n4 + 1).join("0") : i4 > 0 ? coefficient.slice(0, i4) + "." + coefficient.slice(i4) : "0." + new Array(1 - i4).join("0") + formatDecimalParts(x2, Math.max(0, p2 + i4 - 1))[0];
}
...
function locale_default(locale3) {
  ...
  function formatPrefix2(specifier, value) {
    var f2 = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier)), e6 = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k2 = Math.pow(10, -e6), prefix = prefixes[8 + e6 / 3];
...
function bisector_default(f2) {
  ...
  function center(a2, x2, lo, hi) {
    ...
    if (hi == null)
      hi = a2.length;
    const i4 = left(a2, x2, lo, hi - 1);
    return i4 > lo && delta(a2[i4 - 1], x2) > -delta(a2[i4], x2) ? i4 - 1 : i4;
  }
  return { left, center, right };
}
function ascendingComparator(f2) {
  return (d2, x2) => ascending_default2(f2(d2), x2);
}
...
function shuffler(random) {
  return function shuffle2(array2, i0 = 0, i1 = array2.length) {
    let m3 = i1 - (i0 = +i0);
    while (m3) {
      const i4 = random() * m3-- | 0, t4 = array2[m3 + i0];
      array2[m3 + i0] = array2[i4 + i0];
      array2[i4 + i0] = t4;
    }
    return array2;
  };
...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start, stop, count3) {
    ...
    if (i4 === tickIntervals.length)
      return year2.every(tickStep(start / durationYear, stop / durationYear, count3));
    if (i4 === 0)
...
function formatLocale(locale3) {
  ...
  function newFormat(specifier, formats2) {
    return function(date) {
      var string = [], i4 = -1, j3 = 0, n4 = specifier.length, c4, pad2, format2;
      if (!(date instanceof Date))
        date = /* @__PURE__ */ new Date(+date);
      while (++i4 < n4) {
        if (specifier.charCodeAt(i4) === 37) {
          string.push(specifier.slice(j3, i4));
          if ((pad2 = pads[c4 = specifier.charAt(++i4)]) != null)
            c4 = specifier.charAt(++i4);
          else
            pad2 = c4 === "e" ? " " : "0";
          if (format2 = formats2[c4])
            c4 = format2(date, pad2);
          string.push(c4);
          j3 = i4 + 1;
        }
      }
  ...
  function parseSpecifier(d2, specifier, string, j3) {
    var i4 = 0, n4 = specifier.length, m3 = string.length, c4, parse;
    while (i4 < n4) {
      if (j3 >= m3)
        return -1;
      c4 = specifier.charCodeAt(i4++);
      if (c4 === 37) {
        c4 = specifier.charAt(i4++);
        parse = parses[c4 in pads ? specifier.charAt(i4++) : c4];
        if (!parse || (j3 = parse(d2, string, j3)) < 0)
          return -1;
      } else if (c4 != string.charCodeAt(j3++)) {
        return -1;
      }
    }
    return j3;
  ...
  function parsePeriod(d2, string, i4) {
    ...
    return n4 ? (d2.p = periodLookup.get(n4[0].toLowerCase()), i4 + n4[0].length) : -1;
  }
  function parseShortWeekday(d2, string, i4) {
    var n4 = shortWeekdayRe.exec(string.slice(i4));
    return n4 ? (d2.w = shortWeekdayLookup.get(n4[0].toLowerCase()), i4 + n4[0].length) : -1;
  }
  function parseWeekday(d2, string, i4) {
    var n4 = weekdayRe.exec(string.slice(i4));
    return n4 ? (d2.w = weekdayLookup.get(n4[0].toLowerCase()), i4 + n4[0].length) : -1;
  }
  function parseShortMonth(d2, string, i4) {
    var n4 = shortMonthRe.exec(string.slice(i4));
    return n4 ? (d2.m = shortMonthLookup.get(n4[0].toLowerCase()), i4 + n4[0].length) : -1;
  }
  function parseMonth(d2, string, i4) {
    var n4 = monthRe.exec(string.slice(i4));
    return n4 ? (d2.m = monthLookup.get(n4[0].toLowerCase()), i4 + n4[0].length) : -1;
  }
...
function parseWeekdayNumberSunday(d2, string, i4) {
  ...
  return n4 ? (d2.w = +n4[0], i4 + n4[0].length) : -1;
}
function parseWeekdayNumberMonday(d2, string, i4) {
  var n4 = numberRe.exec(string.slice(i4, i4 + 1));
  return n4 ? (d2.u = +n4[0], i4 + n4[0].length) : -1;
}
...
function parseWeekNumberISO(d2, string, i4) {
  var n4 = numberRe.exec(string.slice(i4, i4 + 2));
  return n4 ? (d2.V = +n4[0], i4 + n4[0].length) : -1;
}
...
function parseUnixTimestamp(d2, string, i4) {
  ...
  return n4 ? (d2.Q = +n4[0], i4 + n4[0].length) : -1;
}
...
function jr() {
  return jr = Object.assign ? Object.assign.bind() : function(e6) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var t4 = arguments[r4];
      for (var n4 in t4)
        Object.prototype.hasOwnProperty.call(t4, n4) && (e6[n4] = t4[n4]);
    }
    return e6;
...
function Br(e6, r4) {
  if (null == e6)
    return {};
  var t4, n4, i4 = {}, o4 = Object.keys(e6);
  for (n4 = 0; n4 < o4.length; n4++)
    t4 = o4[n4], r4.indexOf(t4) >= 0 || (i4[t4] = e6[t4]);
  return i4;
}
...
var Lr = function(e6, r4) {
  return jr({}, r4, e6);
};
var Ir = function(e6, r4) {
  var t4 = (0, import_merge2.default)({}, e6, r4);
  return Gr.forEach(function(e7) {
    (0, import_set2.default)(t4, e7, Lr((0, import_get.default)(t4, e7), t4.text));
  }), t4;
};
var Yr = (0, import_react2.createContext)();
var Ar = function(e6) {
  var t4 = e6.children, n4 = e6.animate, i4 = void 0 === n4 || n4, o4 = e6.config, l4 = void 0 === o4 ? "default" : o4, a2 = (0, import_react2.useMemo)(function() {
    var e7 = (0, import_isString.default)(l4) ? config[l4] : l4;
    return { animate: i4, config: e7 };
  }, [i4, l4]);
  return (0, import_jsx_runtime2.jsx)(Yr.Provider, { value: a2, children: t4 });
};
...
var wt = function(e6, t4, n4) {
  return void 0 === n4 && (n4 = {}), (0, import_react2.useMemo)(function() {
    var r4 = jr({}, _t, n4);
    return { margin: r4, innerWidth: e6 - r4.left - r4.right, innerHeight: t4 - r4.top - r4.bottom, outerWidth: e6, outerHeight: t4 };
  }, [e6, t4, n4.top, n4.right, n4.bottom, n4.left]);
};
var kt = function() {
  var e6 = (0, import_react2.useRef)(null), r4 = (0, import_react2.useState)({ left: 0, top: 0, width: 0, height: 0 }), t4 = r4[0], l4 = r4[1], a2 = (0, import_react2.useState)(function() {
    return "undefined" == typeof ResizeObserver ? null : new ResizeObserver(function(e7) {
      var r5 = e7[0];
      return l4(r5.contentRect);
    });
  })[0];
  return (0, import_react2.useEffect)(function() {
    return e6.current && null !== a2 && a2.observe(e6.current), function() {
...
var Ct = {};
var Wt = function(e6) {
  var r4 = e6.theme, t4 = void 0 === r4 ? Ct : r4, n4 = e6.children, i4 = Rt(t4);
...
var Pt = function(e6) {
  var r4 = e6.children, t4 = e6.condition, n4 = e6.wrapper;
  return t4 ? (0, import_react2.cloneElement)(n4, {}, r4) : r4;
};
...
var St = function(e6) {
  var r4 = e6.children, t4 = e6.theme, i4 = e6.renderWrapper, o4 = void 0 === i4 || i4, l4 = e6.isInteractive, a2 = void 0 === l4 || l4, d2 = e6.animate, s2 = e6.motionConfig, u2 = (0, import_react2.useRef)(null);
  return (0, import_jsx_runtime2.jsx)(Wt, { theme: t4, children: (0, import_jsx_runtime2.jsx)(Ar, { animate: d2, config: s2, children: (0, import_jsx_runtime2.jsx)(M, { container: u2, children: (0, import_jsx_runtime2.jsxs)(Pt, { condition: o4, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: jt, ref: u2 }), children: [r4, a2 && (0, import_jsx_runtime2.jsx)(F, {})] }) }) }) });
};
...
var Lt = function(e6) {
  var t4 = e6.children, i4 = e6.theme, o4 = e6.isInteractive, l4 = void 0 === o4 || o4, d2 = e6.renderWrapper, s2 = void 0 === d2 || d2, u2 = e6.animate, c4 = e6.motionConfig, f2 = (0, import_react2.useRef)(null), m3 = V(f2), y3 = m3.actions, v3 = m3.state, _2 = (0, import_react2.useCallback)(function(e7, r4) {
    return y3.showTooltipFromEvent(e7, r4);
  }, [y3.showTooltipFromEvent]), w2 = (0, import_react2.useMemo)(function() {
    return { showTooltip: l4 ? _2 : Bt, hideTooltip: l4 ? y3.hideTooltip : Bt };
  }, [y3.hideTooltip, l4, _2]);
  return (0, import_jsx_runtime2.jsx)(Wt, { theme: i4, children: (0, import_jsx_runtime2.jsx)(Ar, { animate: u2, config: c4, children: (0, import_jsx_runtime2.jsx)(j.Provider, { value: y3, children: (0, import_jsx_runtime2.jsx)(O.Provider, { value: v3, children: (0, import_jsx_runtime2.jsxs)(Pt, { condition: s2, wrapper: (0, import_jsx_runtime2.jsx)("div", { style: Gt, ref: f2 }), children: [t4(w2), l4 && (0, import_jsx_runtime2.jsx)(F, {})] }) }) }) }) });
};
...
var It = function(e6) {
  var r4 = e6.children, t4 = kt(), n4 = t4[0], i4 = t4[1], o4 = i4.width > 0 && i4.height > 0;
...
var Yt = ["id", "colors"];
var Dt = function(e6) {
  var r4 = e6.id, t4 = e6.colors, n4 = Br(e6, Yt);
  return (0, import_jsx_runtime2.jsx)("linearGradient", jr({ id: r4, x1: 0, x2: 0, y1: 0, y2: 1 }, n4, { children: t4.map(function(e7) {
    var r5 = e7.offset, t5 = e7.color, n5 = e7.opacity;
    return (0, import_jsx_runtime2.jsx)("stop", { offset: r5 + "%", stopColor: t5, stopOpacity: void 0 !== n5 ? n5 : 1 }, r5);
  }) }));
};
...
var Ft = (0, import_react2.memo)(function(e6) {
  var r4 = e6.id, t4 = e6.background, n4 = void 0 === t4 ? Ut.background : t4, i4 = e6.color, o4 = void 0 === i4 ? Ut.color : i4, l4 = e6.size, a2 = void 0 === l4 ? Ut.size : l4, d2 = e6.padding, s2 = void 0 === d2 ? Ut.padding : d2, u2 = e6.stagger, c4 = void 0 === u2 ? Ut.stagger : u2, f2 = a2 + s2, p2 = a2 / 2, h = s2 / 2;
  return true === c4 && (f2 = 2 * a2 + 2 * s2), (0, import_jsx_runtime2.jsxs)("pattern", { id: r4, width: f2, height: f2, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f2, height: f2, fill: n4 }), (0, import_jsx_runtime2.jsx)("circle", { cx: h + p2, cy: h + p2, r: p2, fill: o4 }), c4 && (0, import_jsx_runtime2.jsx)("circle", { cx: 1.5 * s2 + a2 + p2, cy: 1.5 * s2 + a2 + p2, r: p2, fill: o4 })] });
});
...
var on = (0, import_react2.memo)(function(e6) {
  var r4 = e6.id, t4 = e6.spacing, n4 = void 0 === t4 ? nn.spacing : t4, i4 = e6.rotation, o4 = void 0 === i4 ? nn.rotation : i4, l4 = e6.background, a2 = void 0 === l4 ? nn.background : l4, d2 = e6.color, s2 = void 0 === d2 ? nn.color : d2, u2 = e6.lineWidth, c4 = void 0 === u2 ? nn.lineWidth : u2, f2 = Math.round(o4) % 360, p2 = Math.abs(n4);
  f2 > 180 ? f2 -= 360 : f2 > 90 ? f2 -= 180 : f2 < -180 ? f2 += 360 : f2 < -90 && (f2 += 180);
  var h, g3 = p2, b2 = p2;
  return 0 === f2 ? h = "\n                M 0 0 L " + g3 + " 0\n                M 0 " + b2 + " L " + g3 + " " + b2 + "\n            " : 90 === f2 ? h = "\n                M 0 0 L 0 " + b2 + "\n                M " + g3 + " 0 L " + g3 + " " + b2 + "\n            " : (g3 = Math.abs(p2 / Math.sin(Kt(f2))), b2 = p2 / Math.sin(Kt(90 - f2)), h = f2 > 0 ? "\n                    M 0 " + -b2 + " L " + 2 * g3 + " " + b2 + "\n                    M " + -g3 + " " + -b2 + " L " + g3 + " " + b2 + "\n                    M " + -g3 + " 0 L " + g3 + " " + 2 * b2 + "\n                " : "\n                    M " + -g3 + " " + b2 + " L " + g3 + " " + -b2 + "\n                    M " + -g3 + " " + 2 * b2 + " L " + 2 * g3 + " " + -b2 + "\n                    M 0 " + 2 * b2 + " L " + 2 * g3 + " 0\n                "), (0, import_jsx_runtime2.jsxs)("pattern", { id: r4, width: g3, height: b2, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: g3, height: b2, fill: a2, stroke: "rgba(255, 0, 0, 0.1)", strokeWidth: 0 }), (0, import_jsx_runtime2.jsx)("path", { d: h, strokeWidth: c4, stroke: s2, strokeLinecap: "square" })] });
});
...
var dn = (0, import_react2.memo)(function(e6) {
  var r4 = e6.id, t4 = e6.color, n4 = void 0 === t4 ? an.color : t4, i4 = e6.background, o4 = void 0 === i4 ? an.background : i4, l4 = e6.size, a2 = void 0 === l4 ? an.size : l4, d2 = e6.padding, s2 = void 0 === d2 ? an.padding : d2, u2 = e6.stagger, c4 = void 0 === u2 ? an.stagger : u2, f2 = a2 + s2, p2 = s2 / 2;
  return true === c4 && (f2 = 2 * a2 + 2 * s2), (0, import_jsx_runtime2.jsxs)("pattern", { id: r4, width: f2, height: f2, patternUnits: "userSpaceOnUse", children: [(0, import_jsx_runtime2.jsx)("rect", { width: f2, height: f2, fill: o4 }), (0, import_jsx_runtime2.jsx)("rect", { x: p2, y: p2, width: a2, height: a2, fill: n4 }), c4 && (0, import_jsx_runtime2.jsx)("rect", { x: 1.5 * s2 + a2, y: 1.5 * s2 + a2, width: a2, height: a2, fill: n4 })] });
});
...
var pn = function(e6) {
  var r4 = e6.defs;
  return !r4 || r4.length < 1 ? null : (0, import_jsx_runtime2.jsx)("defs", { "aria-hidden": true, children: r4.map(function(e7) {
    var r5 = e7.type, t4 = Br(e7, cn);
    return fn[r5] ? (0, import_react2.createElement)(fn[r5], jr({ key: t4.id }, t4)) : null;
  }) });
};
...
var gn = function(e6) {
  var r4 = e6.width, t4 = e6.height, n4 = e6.margin, i4 = e6.defs, o4 = e6.children, l4 = e6.role, a2 = e6.ariaLabel, d2 = e6.ariaLabelledBy, s2 = e6.ariaDescribedBy, u2 = e6.isFocusable, c4 = zt();
  return (0, import_jsx_runtime2.jsxs)("svg", { xmlns: "http://www.w3.org/2000/svg", width: r4, height: t4, role: l4, "aria-label": a2, "aria-labelledby": d2, "aria-describedby": s2, focusable: u2, tabIndex: u2 ? 0 : void 0, children: [(0, import_jsx_runtime2.jsx)(hn, { defs: i4 }), (0, import_jsx_runtime2.jsx)("rect", { width: r4, height: t4, fill: c4.background }), (0, import_jsx_runtime2.jsx)("g", { transform: "translate(" + n4.left + "," + n4.top + ")", children: o4 })] });
};
...
var bn = function(e6) {
  var r4 = e6.size, t4 = e6.color, n4 = e6.borderWidth, i4 = e6.borderColor;
  return (0, import_jsx_runtime2.jsx)("circle", { r: r4 / 2, fill: t4, stroke: i4, strokeWidth: n4, style: { pointerEvents: "none" } });
};
...
var yn = function(e6) {
  var r4 = e6.x, t4 = e6.y, n4 = e6.symbol, i4 = void 0 === n4 ? mn : n4, o4 = e6.size, l4 = e6.datum, a2 = e6.color, d2 = e6.borderWidth, u2 = e6.borderColor, c4 = e6.label, f2 = e6.labelTextAnchor, p2 = void 0 === f2 ? "middle" : f2, h = e6.labelYOffset, g3 = void 0 === h ? -12 : h, b2 = zt(), m3 = Ur(), y3 = m3.animate, v3 = m3.config, _2 = useSpring({ transform: "translate(" + r4 + ", " + t4 + ")", config: v3, immediate: !y3 });
  return (0, import_jsx_runtime2.jsxs)(animated.g, { transform: _2.transform, style: { pointerEvents: "none" }, children: [(0, import_react2.createElement)(i4, { size: o4, color: a2, datum: l4, borderWidth: d2, borderColor: u2 }), c4 && (0, import_jsx_runtime2.jsx)("text", { textAnchor: p2, y: g3, style: Mt(b2.dots.text), children: c4 })] });
};
...
var _n = function(e6) {
  var r4 = e6.width, t4 = e6.height, n4 = e6.axis, i4 = e6.scale, o4 = e6.value, l4 = e6.lineStyle, a2 = e6.textStyle, d2 = e6.legend, s2 = e6.legendPosition, u2 = void 0 === s2 ? "top-right" : s2, c4 = e6.legendOffsetX, f2 = void 0 === c4 ? 14 : c4, p2 = e6.legendOffsetY, h = void 0 === p2 ? 14 : p2, g3 = e6.legendOrientation, b2 = void 0 === g3 ? "horizontal" : g3, m3 = zt(), y3 = 0, v3 = 0, _2 = 0, w2 = 0;
  "y" === n4 ? (_2 = i4(o4), v3 = r4) : (y3 = i4(o4), w2 = t4);
  var k2 = null;
  if (d2) {
    var R = function(e7) {
      var r5 = e7.axis, t5 = e7.width, n5 = e7.height, i5 = e7.position, o5 = e7.offsetX, l5 = e7.offsetY, a3 = e7.orientation, d3 = 0, s3 = 0, u3 = "vertical" === a3 ? -90 : 0, c5 = "start";
      if ("x" === r5)
        switch (i5) {
          case "top-left":
            d3 = -o5, s3 = l5, c5 = "end";
            break;
          case "top":
            s3 = -l5, c5 = "horizontal" === a3 ? "middle" : "start";
            break;
          case "top-right":
            d3 = o5, s3 = l5, c5 = "horizontal" === a3 ? "start" : "end";
            break;
          case "right":
            d3 = o5, s3 = n5 / 2, c5 = "horizontal" === a3 ? "start" : "middle";
            break;
          case "bottom-right":
            d3 = o5, s3 = n5 - l5, c5 = "start";
            break;
          case "bottom":
            s3 = n5 + l5, c5 = "horizontal" === a3 ? "middle" : "end";
            break;
          case "bottom-left":
            s3 = n5 - l5, d3 = -o5, c5 = "horizontal" === a3 ? "end" : "start";
            break;
          case "left":
            d3 = -o5, s3 = n5 / 2, c5 = "horizontal" === a3 ? "end" : "middle";
        }
      else
        switch (i5) {
          case "top-left":
            d3 = o5, s3 = -l5, c5 = "start";
            break;
          case "top":
            d3 = t5 / 2, s3 = -l5, c5 = "horizontal" === a3 ? "middle" : "start";
            break;
          case "top-right":
            d3 = t5 - o5, s3 = -l5, c5 = "horizontal" === a3 ? "end" : "start";
            break;
          case "right":
            d3 = t5 + o5, c5 = "horizontal" === a3 ? "start" : "middle";
            break;
          case "bottom-right":
            d3 = t5 - o5, s3 = l5, c5 = "end";
            break;
          case "bottom":
            d3 = t5 / 2, s3 = l5, c5 = "horizontal" === a3 ? "middle" : "end";
            break;
          case "bottom-left":
            d3 = o5, s3 = l5, c5 = "horizontal" === a3 ? "start" : "end";
            break;
          case "left":
            d3 = -o5, c5 = "horizontal" === a3 ? "end" : "middle";
        }
      return { x: d3, y: s3, rotation: u3, textAnchor: c5 };
    }({ axis: n4, width: r4, height: t4, position: u2, offsetX: f2, offsetY: h, orientation: b2 });
    k2 = (0, import_jsx_runtime2.jsx)("text", { transform: "translate(" + R.x + ", " + R.y + ") rotate(" + R.rotation + ")", textAnchor: R.textAnchor, dominantBaseline: "central", style: a2, children: d2 });
  }
  return (0, import_jsx_runtime2.jsxs)("g", { transform: "translate(" + y3 + ", " + _2 + ")", children: [(0, import_jsx_runtime2.jsx)("line", { x1: 0, x2: v3, y1: 0, y2: w2, stroke: m3.markers.lineColor, strokeWidth: m3.markers.lineStrokeWidth, style: l4 }), k2] });
};
...
var kn = function(e6) {
  var r4 = e6.markers, t4 = e6.width, n4 = e6.height, i4 = e6.xScale, o4 = e6.yScale;
  return r4 && 0 !== r4.length ? r4.map(function(e7, r5) {
    return (0, import_jsx_runtime2.jsx)(wn, jr({}, e7, { width: t4, height: n4, scale: "y" === e7.axis ? o4 : i4 }), r5);
  }) : null;
};
...
var Mn = function(e6, r4, t4, n4) {
  var i4 = t4 - e6, o4 = n4 - r4;
  return i4 *= i4, o4 *= o4, Math.sqrt(i4 + o4);
};
var Sn = function(e6, r4) {
  var t4, n4 = "touches" in r4 ? r4.touches[0] : r4, i4 = n4.clientX, o4 = n4.clientY, l4 = e6.getBoundingClientRect(), a2 = (t4 = void 0 !== e6.getBBox ? e6.getBBox() : { width: e6.offsetWidth || 0, height: e6.offsetHeight || 0 }).width === l4.width ? 1 : t4.width / l4.width;
  return [(i4 - l4.left) * a2, (o4 - l4.top) * a2];
};
var Bn = Object.keys(Et);
var Gn = Object.keys(un);
var Ln = function(e6, r4, t4) {
  if ("*" === e6)
    return true;
  if ((0, import_isFunction.default)(e6))
    return e6(r4);
  if ((0, import_isPlainObject.default)(e6)) {
    var n4 = t4 ? (0, import_get.default)(r4, t4) : r4;
    return (0, import_isEqual.default)((0, import_pick.default)(n4, Object.keys(e6)), e6);
  }
  return false;
};
var In = function(e6, r4, t4, n4) {
  var i4 = void 0 === n4 ? {} : n4, o4 = i4.dataKey, l4 = i4.colorKey, a2 = void 0 === l4 ? "color" : l4, d2 = i4.targetKey, s2 = void 0 === d2 ? "fill" : d2, u2 = [], c4 = {};
  return e6.length && r4.length && (u2 = [].concat(e6), r4.forEach(function(r5) {
    for (var n5 = function() {
      var n6 = t4[i5], l5 = n6.id, d3 = n6.match;
      if (Ln(d3, r5, o4)) {
        var f2 = e6.find(function(e7) {
          return e7.id === l5;
        });
        if (f2) {
          if (Gn.includes(f2.type))
            if ("inherit" === f2.background || "inherit" === f2.color) {
              var p2 = (0, import_get.default)(r5, a2), h = f2.background, g3 = f2.color, b2 = l5;
              "inherit" === f2.background && (b2 = b2 + ".bg." + p2, h = p2), "inherit" === f2.color && (b2 = b2 + ".fg." + p2, g3 = p2), (0, import_set2.default)(r5, s2, "url(#" + b2 + ")"), c4[b2] || (u2.push(jr({}, f2, { id: b2, background: h, color: g3 })), c4[b2] = 1);
            } else
              (0, import_set2.default)(r5, s2, "url(#" + l5 + ")");
          else if (Bn.includes(f2.type)) {
            if (f2.colors.map(function(e7) {
              return e7.color;
            }).includes("inherit")) {
              var m3 = (0, import_get.default)(r5, a2), _2 = l5, w2 = jr({}, f2, { colors: f2.colors.map(function(e7, r6) {
                return "inherit" !== e7.color ? e7 : (_2 = _2 + "." + r6 + "." + m3, jr({}, e7, { color: "inherit" === e7.color ? m3 : e7.color }));
              }) });
              w2.id = _2, (0, import_set2.default)(r5, s2, "url(#" + _2 + ")"), c4[_2] || (u2.push(w2), c4[_2] = 1);
            } else
              (0, import_set2.default)(r5, s2, "url(#" + l5 + ")");
          }
        }
...
function count2(node) {
  var sum2 = 0, children = node.children, i4 = children && children.length;
  if (!i4)
    sum2 = 1;
  else
    while (--i4 >= 0)
      sum2 += children[i4].value;
  node.value = sum2;
}
...
function each_default(callback) {
  var node = this, current, next = [node], children, i4, n4;
  do {
    current = next.reverse(), next = [];
    while (node = current.pop()) {
      callback(node), children = node.children;
      if (children)
        for (i4 = 0, n4 = children.length; i4 < n4; ++i4) {
...
function eachBefore_default(callback) {
  var node = this, nodes = [node], children, i4;
...
function eachAfter_default(callback) {
  var node = this, nodes = [node], next = [], children, i4, n4;
  while (node = nodes.pop()) {
...
function sum_default(value) {
  return this.eachAfter(function(node) {
    var sum2 = +value(node.data) || 0, children = node.children, i4 = children && children.length;
    while (--i4 >= 0)
      sum2 += children[i4].value;
    node.value = sum2;
  });
...
function hierarchy(data, children) {
  var root = new Node(data), valued = +data.value && (root.value = data.value), node, nodes = [root], child, childs, i4, n4;
  if (children == null)
    children = defaultChildren;
  while (node = nodes.pop()) {
    if (valued)
      node.value = +node.data.value;
    if ((childs = children(node.data)) && (n4 = childs.length)) {
      node.children = new Array(n4);
      for (i4 = n4 - 1; i4 >= 0; --i4) {
        nodes.push(child = node.children[i4] = new Node(childs[i4]));
        child.parent = node;
...
function enclose_default(circles) {
  var i4 = 0, n4 = (circles = shuffle(slice2.call(circles))).length, B2 = [], p2, e6;
  while (i4 < n4) {
    p2 = circles[i4];
    if (e6 && enclosesWeak(e6, p2))
      ++i4;
    else
      e6 = encloseBasis(B2 = extendBasis(B2, p2)), i4 = 0;
  }
  return e6;
}
function extendBasis(B2, p2) {
  ...
  if (enclosesWeakAll(p2, B2))
    return [p2];
  for (i4 = 0; i4 < B2.length; ++i4) {
    if (enclosesNot(p2, B2[i4]) && enclosesWeakAll(encloseBasis2(B2[i4], p2), B2)) {
      return [B2[i4], p2];
    }
  }
  for (i4 = 0; i4 < B2.length - 1; ++i4) {
    for (j3 = i4 + 1; j3 < B2.length; ++j3) {
      if (enclosesNot(encloseBasis2(B2[i4], B2[j3]), p2) && enclosesNot(encloseBasis2(B2[i4], p2), B2[j3]) && enclosesNot(encloseBasis2(B2[j3], p2), B2[i4]) && enclosesWeakAll(encloseBasis3(B2[i4], B2[j3], p2), B2)) {
        return [B2[i4], B2[j3], p2];
      }
    }
  }
  throw new Error();
...
function encloseBasis2(a2, b2) {
  var x1 = a2.x, y1 = a2.y, r1 = a2.r, x2 = b2.x, y22 = b2.y, r22 = b2.r, x21 = x2 - x1, y21 = y22 - y1, r21 = r22 - r1, l4 = Math.sqrt(x21 * x21 + y21 * y21);
  return {
    x: (x1 + x2 + x21 / l4 * r21) / 2,
    y: (y1 + y22 + y21 / l4 * r21) / 2,
    r: (l4 + r1 + r22) / 2
  };
}
function encloseBasis3(a2, b2, c4) {
  var x1 = a2.x, y1 = a2.y, r1 = a2.r, x2 = b2.x, y22 = b2.y, r22 = b2.r, x3 = c4.x, y3 = c4.y, r32 = c4.r, a22 = x1 - x2, a3 = x1 - x3, b22 = y1 - y22, b3 = y1 - y3, c22 = r22 - r1, c32 = r32 - r1, d1 = x1 * x1 + y1 * y1 - r1 * r1, d2 = d1 - x2 * x2 - y22 * y22 + r22 * r22, d3 = d1 - x3 * x3 - y3 * y3 + r32 * r32, ab = a3 * b22 - a22 * b3, xa = (b22 * d3 - b3 * d2) / (ab * 2) - x1, xb = (b3 * c22 - b22 * c32) / ab, ya = (a3 * d2 - a22 * d3) / (ab * 2) - y1, yb = (a22 * c32 - a3 * c22) / ab, A3 = xb * xb + yb * yb - 1, B2 = 2 * (r1 + xa * xb + ya * yb), C3 = xa * xa + ya * ya - r1 * r1, r4 = -(A3 ? (B2 + Math.sqrt(B2 * B2 - 4 * A3 * C3)) / (2 * A3) : C3 / B2);
  return {
    x: x1 + xa + xb * r4,
    y: y1 + ya + yb * r4,
    r: r4
...
function place(b2, a2, c4) {
  var dx = b2.x - a2.x, x2, a22, dy = b2.y - a2.y, y3, b22, d2 = dx * dx + dy * dy;
  if (d2) {
    a22 = a2.r + c4.r, a22 *= a22;
    b22 = b2.r + c4.r, b22 *= b22;
    if (a22 > b22) {
      x2 = (d2 + b22 - a22) / (2 * d2);
      y3 = Math.sqrt(Math.max(0, b22 / d2 - x2 * x2));
      c4.x = b2.x - x2 * dx - y3 * dy;
      c4.y = b2.y - x2 * dy + y3 * dx;
    } else {
      x2 = (d2 + a22 - b22) / (2 * d2);
      y3 = Math.sqrt(Math.max(0, a22 / d2 - x2 * x2));
      c4.x = a2.x + x2 * dx - y3 * dy;
      c4.y = a2.y + x2 * dy + y3 * dx;
    }
  } else {
    c4.x = a2.x + c4.r;
    c4.y = a2.y;
...
function packEnclose(circles) {
  if (!(n4 = circles.length))
    return 0;
  var a2, b2, c4, n4, aa, ca, i4, j3, k2, sj, sk;
  ...
  if (!(n4 > 2))
    return a2.r + b2.r;
  place(b2, a2, c4 = circles[2]);
  a2 = new Node2(a2), b2 = new Node2(b2), c4 = new Node2(c4);
  a2.next = c4.previous = b2;
  b2.next = a2.previous = c4;
  c4.next = b2.previous = a2;
  pack:
    for (i4 = 3; i4 < n4; ++i4) {
      place(a2._, b2._, c4 = circles[i4]), c4 = new Node2(c4);
      j3 = b2.next, k2 = a2.previous, sj = b2._.r, sk = a2._.r;
      do {
        if (sj <= sk) {
          if (intersects(j3._, c4._)) {
            b2 = j3, a2.next = b2, b2.previous = a2, --i4;
            continue pack;
          }
          sj += j3._.r, j3 = j3.next;
        } else {
          if (intersects(k2._, c4._)) {
            a2 = k2, a2.next = b2, b2.previous = a2, --i4;
            continue pack;
          }
          sk += k2._.r, k2 = k2.previous;
        }
      } while (j3 !== k2.next);
      c4.previous = a2, c4.next = b2, a2.next = b2.previous = b2 = c4;
      aa = score(a2);
      while ((c4 = c4.next) !== b2) {
        if ((ca = score(c4)) < aa) {
          a2 = c4, aa = ca;
  ...
  for (i4 = 0; i4 < n4; ++i4)
    a2 = circles[i4], a2.x -= c4.x, a2.y -= c4.y;
  return c4.r;
}
...
function pack_default() {
  ...
  pack.padding = function(x2) {
    return arguments.length ? (padding = typeof x2 === "function" ? x2 : constant_default2(+x2), pack) : padding;
  };
  return pack;
}
...
function packChildren(padding, k2) {
  return function(node) {
    if (children = node.children) {
      var children, i4, n4 = children.length, r4 = padding(node) * k2 || 0, e6;
      if (r4)
        for (i4 = 0; i4 < n4; ++i4)
          children[i4].r += r4;
      e6 = packEnclose(children);
      if (r4)
        for (i4 = 0; i4 < n4; ++i4)
          children[i4].r -= r4;
      node.r = e6 + r4;
...
function dice_default(parent, x0, y0, x1, y1) {
  var nodes = parent.children, node, i4 = -1, n4 = nodes.length, k2 = parent.value && (x1 - x0) / parent.value;
  while (++i4 < n4) {
...
function slice_default(parent, x0, y0, x1, y1) {
  var nodes = parent.children, node, i4 = -1, n4 = nodes.length, k2 = parent.value && (y1 - y0) / parent.value;
  while (++i4 < n4) {
...
function squarifyRatio(ratio, parent, x0, y0, x1, y1) {
  var rows = [], nodes = parent.children, row, nodeValue, i0 = 0, i1 = 0, n4 = nodes.length, dx, dy, value = parent.value, sumValue, minValue, maxValue, newRatio, minRatio, alpha, beta;
  while (i0 < n4) {
    dx = x1 - x0, dy = y1 - y0;
    do
      sumValue = nodes[i1++].value;
    while (!sumValue && i1 < n4);
...
var resquarify_default = function custom2(ratio) {
  function resquarify(parent, x0, y0, x1, y1) {
    if ((rows = parent._squarify) && rows.ratio === ratio) {
      var rows, row, nodes, i4, j3 = -1, n4, m3 = rows.length, value = parent.value;
      while (++j3 < m3) {
        row = rows[j3], nodes = row.children;
        for (i4 = row.value = 0, n4 = nodes.length; i4 < n4; ++i4)
...
function qe() {
  return qe = Object.assign ? Object.assign.bind() : function(e6) {
    for (var r4 = 1; r4 < arguments.length; r4++) {
      var n4 = arguments[r4];
      for (var t4 in n4)
        Object.prototype.hasOwnProperty.call(n4, t4) && (e6[t4] = n4[t4]);
    }
    return e6;
...
function Ce(e6, r4) {
  ...
  for (var n4 = 0, t4 = new Array(r4); n4 < r4; n4++)
    t4[n4] = e6[n4];
  return t4;
}
function Ge(e6, r4) {
  ...
  if (n4)
    return (n4 = n4.call(e6)).next.bind(n4);
  if (Array.isArray(e6) || (n4 = function(e7, r5) {
    if (e7) {
      if ("string" == typeof e7)
        return Ce(e7, r5);
      var n5 = Object.prototype.toString.call(e7).slice(8, -1);
      return "Object" === n5 && e7.constructor && (n5 = e7.constructor.name), "Map" === n5 || "Set" === n5 ? Array.from(e7) : "Arguments" === n5 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n5) ? Ce(e7, r5) : void 0;
    }
  }(e6)) || r4 && e6 && "number" == typeof e6.length) {
    n4 && (e6 = n4);
    var t4 = 0;
    return function() {
      return t4 >= e6.length ? { done: true } : { done: false, value: e6[t4++] };
    };
  }
...
var We = function(e6, r4) {
  ...
  if ((0, import_isPlainObject2.default)(e6)) {
    if (function(e7) {
      ...
      var n4 = (0, import_get2.default)(r4, e6.theme);
      if (void 0 === n4)
    ...
    if (function(e7) {
      ...
      if (Array.isArray(e6.modifiers)) {
        for (var o4, i4 = [], u2 = function() {
          var e7 = o4.value, r5 = e7[0], n5 = e7[1];
          if ("brighter" === r5)
            i4.push(function(e8) {
              return e8.brighter(n5);
            });
          else if ("darker" === r5)
            i4.push(function(e8) {
              return e8.darker(n5);
            ...
            i4.push(function(e8) {
              return e8.opacity = n5, e8;
            });
          }
        }, a2 = Ge(e6.modifiers); !(o4 = a2()).done; )
          u2();
        return 0 === i4.length ? t4 : function(e7) {
...
var fr = function(e6, r4) {
  if ("function" == typeof e6)
    return e6;
  var n4 = "function" == typeof r4 ? r4 : function(e7) {
    return (0, import_get2.default)(e7, r4);
  };
  if (Array.isArray(e6)) {
    var t4 = ordinal(e6), o4 = function(e7) {
      return t4(n4(e7));
    };
    return o4.scale = t4, o4;
  }
  if ((0, import_isPlainObject2.default)(e6)) {
    if (function(e7) {
    ...
    if (function(e7) {
      ...
      if (He(e6.scheme)) {
        var i4 = ordinal(Be[e6.scheme]), u2 = function(e7) {
          return i4(n4(e7));
        };
      ...
      if (Je(e6.scheme)) {
        ...
        var a2 = ordinal(Be[e6.scheme][e6.size || 11]), l4 = function(e7) {
          return a2(n4(e7));
        };
        return l4.scale = a2, l4;
      }
      if (Ke(e6.scheme)) {
        ...
        var c4 = ordinal(Be[e6.scheme][e6.size || 9]), s2 = function(e7) {
          return c4(n4(e7));
        };
        return s2.scale = c4, s2;
      }
    }
...
function O3() {
  return O3 = Object.assign ? Object.assign.bind() : function(e6) {
    for (var o4 = 1; o4 < arguments.length; o4++) {
      var r4 = arguments[o4];
      for (var i4 in r4)
        Object.prototype.hasOwnProperty.call(r4, i4) && (e6[i4] = r4[i4]);
    }
    return e6;
...
function P2(e6, o4) {
  if (null == e6)
    return {};
  var r4, i4, n4 = {}, t4 = Object.keys(e6);
  for (i4 = 0; i4 < t4.length; i4++)
    r4 = t4[i4], o4.indexOf(r4) >= 0 || (n4[r4] = e6[r4]);
  return n4;
}
var B;
var S = function(e6) {
  var o4, r4 = e6.data, i4 = e6.id, n4 = e6.value, t4 = e6.valueFormat, l4 = e6.width, c4 = e6.height, s2 = e6.padding, v3 = e6.leavesOnly, f2 = e6.colors, h = e6.colorBy, p2 = e6.inheritColorFromParent, m3 = e6.childColor, b2 = Wn(i4), w2 = Wn(n4), I = Ot(t4), E3 = pr(f2, h), F3 = zt(), W2 = Xe(m3, F3), L = (0, import_cloneDeep.default)(r4), R = hierarchy(L).sum(w2), O4 = pack_default().size([l4, c4]).padding(s2)(R), P3 = v3 ? O4.leaves() : O4.descendants(), B2 = (0, import_sortBy.default)(P3, "depth"), S2 = null != (o4 = R.value) ? o4 : 0, T3 = B2.reduce(function(e7, o5) {
    var r5, i5 = b2(o5.data), n5 = o5.value, l5 = 100 * n5 / S2, a2 = o5.ancestors().map(function(e8) {
      return b2(e8.data);
    });
    o5.parent && (r5 = e7.find(function(e8) {
      return e8.id === b2(o5.parent.data);
    }));
    var d2 = { id: i5, path: a2, value: n5, percentage: l5, formattedValue: t4 ? I(n5) : l5.toFixed(2) + "%", x: o5.x, y: o5.y, radius: o5.r, color: "", data: o5.data, depth: o5.depth, height: o5.height };
    return p2 && r5 && d2.depth > 1 ? d2.color = W2(r5) : d2.color = E3(d2), [].concat(e7, [d2]);
  }, []);
  return T3;
};
var T2 = function(e6, r4, i4, n4) {
  return (0, import_react4.useMemo)(function() {
    if (!r4)
      return e6;
    var o4 = e6.find(function(e7) {
      return e7.id === r4;
    });
    if (!o4)
      return e6;
    var t4 = Math.min(i4, n4) / (2 * o4.radius), l4 = i4 / 2 - o4.x * t4, a2 = n4 / 2 - o4.y * t4;
    return e6.map(function(e7) {
      return O3({}, e7, { x: e7.x * t4 + l4, y: e7.y * t4 + a2, radius: e7.radius * t4 });
    });
  }, [e6, r4, i4, n4]);
};
var j2 = function(e6) {
  var r4 = e6.nodes, i4 = e6.label, n4 = e6.filter, t4 = e6.skipRadius, l4 = e6.textColor, d2 = Wn(i4), c4 = zt(), s2 = Xe(l4, c4), v3 = (0, import_react4.useMemo)(function() {
    return r4.filter(function(e7) {
      return e7.radius >= t4;
    }).map(function(e7) {
      return { label: d2(e7), textColor: s2(e7), node: e7 };
    });
  }, [r4, t4, d2, s2]);
  return (0, import_react4.useMemo)(function() {
    return n4 ? v3.filter(n4) : v3;
  }, [v3, n4]);
};
var z3 = function(e6, r4) {
  var i4 = r4.onMouseEnter, n4 = r4.onMouseMove, t4 = r4.onMouseLeave, l4 = r4.onClick;
  return (0, import_react4.useMemo)(function() {
    return { onMouseEnter: i4 ? function(o4) {
      i4(e6, o4);
    } : void 0, onMouseMove: n4 ? function(o4) {
      n4(e6, o4);
    } : void 0, onMouseLeave: t4 ? function(o4) {
      t4(e6, o4);
    } : void 0, onClick: l4 ? function(o4) {
      l4(e6, o4);
    } : void 0 };
  }, [e6, i4, n4, t4, l4]);
};
var H = function(e6) {
  var i4 = e6.nodes, n4 = e6.canvasEl, t4 = e6.margin, l4 = (0, import_react4.useMemo)(function() {
    return (0, import_sortBy.default)(i4, "height");
  }, [i4]);
  return (0, import_react4.useCallback)(function(e7) {
    if (!n4.current)
      return null;
    var o4 = Sn(n4.current, e7), r4 = o4[0], i5 = o4[1];
    return l4.find(function(e8) {
      return Mn(e8.x, e8.y, r4 - t4.left, i5 - t4.top) <= e8.radius;
    });
  }, [n4, t4, l4]);
};
var A2 = function(e6) {
...
var V2 = { id: "id", value: "value", padding: 0, leavesOnly: false, layers: ["circles", "labels"], colors: { scheme: "nivo" }, colorBy: "depth", inheritColorFromParent: false, childColor: { from: "color", modifiers: [["darker", 0.3]] }, borderWidth: 0, borderColor: { from: "color", modifiers: [["darker", 0.3]] }, defs: [], fill: [], enableLabels: false, label: "id", labelTextColor: { from: "color", modifiers: [["darker", 1.6]] }, labelsSkipRadius: 8, isInteractive: true, tooltip: function(e6) {
  var o4 = e6.id, r4 = e6.formattedValue, i4 = e6.color;
  return (0, import_jsx_runtime3.jsx)(w, { id: o4, value: r4, enableChip: true, color: i4 });
}, animate: true, motionConfig: "gentle", role: "img", pixelRatio: "undefined" != typeof window && null != (B = window.devicePixelRatio) ? B : 1 };
var D = function(e6) {
  return to([e6], function(e7) {
    return Math.max(0, e7);
  });
};
var K = function(r4) {
  var n4 = r4.nodes, t4 = r4.borderWidth, l4 = r4.borderColor, a2 = r4.component, d2 = r4.isInteractive, c4 = r4.onMouseEnter, s2 = r4.onMouseMove, f2 = r4.onMouseLeave, h = r4.onClick, p2 = r4.tooltip, m3 = k(), b2 = m3.showTooltipFromEvent, y3 = m3.hideTooltip, C3 = (0, import_react4.useMemo)(function() {
    if (d2)
      return function(e6, o4) {
        b2((0, import_react4.createElement)(p2, e6), o4), null == c4 || c4(e6, o4);
      };
  }, [d2, b2, p2, c4]), g3 = (0, import_react4.useMemo)(function() {
    if (d2)
      return function(e6, o4) {
        b2((0, import_react4.createElement)(p2, e6), o4), null == s2 || s2(e6, o4);
      };
  }, [d2, b2, p2, s2]), M3 = (0, import_react4.useMemo)(function() {
    if (d2)
      return function(e6, o4) {
        y3(), null == f2 || f2(e6, o4);
      };
  }, [d2, y3, f2]), x2 = (0, import_react4.useMemo)(function() {
    if (d2)
      return function(e6, o4) {
        null == h || h(e6, o4);
      };
  }, [d2, h]), w2 = Ur(), L = w2.animate, R = w2.config, P3 = zt(), B2 = Xe(l4, P3), S2 = (0, import_react4.useMemo)(function() {
    return /* @__PURE__ */ function(e6) {
      return { enter: function(o4) {
        return { x: o4.x, y: o4.y, radius: 0, color: o4.color, borderColor: e6(o4), opacity: 0 };
      }, update: function(o4) {
        return { x: o4.x, y: o4.y, radius: o4.radius, color: o4.color, borderColor: e6(o4), opacity: 1 };
      }, leave: function(o4) {
        return { x: o4.x, y: o4.y, radius: 0, color: o4.color, borderColor: e6(o4), opacity: 0 };
      } };
    }(B2);
  }, [B2]), T3 = useTransition(n4, { keys: function(e6) {
    return e6.id;
  }, initial: S2.update, from: S2.enter, enter: S2.update, update: S2.update, leave: S2.leave, config: R, immediate: !L });
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: T3(function(o4, r5) {
    return e4.createElement(a2, { key: r5.id, node: r5, style: O3({}, o4, { radius: D(o4.radius), borderWidth: t4 }), onMouseEnter: C3, onMouseMove: g3, onMouseLeave: M3, onClick: x2 });
  }) });
};
var q2 = function(e6) {
  var o4 = e6.node, r4 = e6.style, i4 = e6.onMouseEnter, n4 = e6.onMouseMove, t4 = e6.onMouseLeave, l4 = e6.onClick, a2 = z3(o4, { onMouseEnter: i4, onMouseMove: n4, onMouseLeave: t4, onClick: l4 });
  return (0, import_jsx_runtime3.jsx)(animated.circle, { cx: r4.x, cy: r4.y, r: r4.radius, fill: o4.fill || r4.color, stroke: r4.borderColor, strokeWidth: r4.borderWidth, opacity: r4.opacity, onMouseEnter: a2.onMouseEnter, onMouseMove: a2.onMouseMove, onMouseLeave: a2.onMouseLeave, onClick: a2.onClick }, o4.id);
};
var G = function(e6) {
  var r4 = e6.nodes, n4 = e6.label, t4 = e6.filter, l4 = e6.skipRadius, a2 = e6.textColor, d2 = e6.component, u2 = Ur(), c4 = u2.animate, s2 = u2.config, f2 = j2({ nodes: r4, label: n4, filter: t4, skipRadius: l4, textColor: a2 }), h = (0, import_react4.useMemo)(function() {
    return { enter: function(e7) {
      return { x: e7.node.x, y: e7.node.y, radius: e7.node.radius, textColor: e7.textColor, opacity: 0 };
    }, update: function(e7) {
      return { x: e7.node.x, y: e7.node.y, radius: e7.node.radius, textColor: e7.textColor, opacity: 1 };
    }, leave: function(e7) {
      return { x: e7.node.x, y: e7.node.y, radius: e7.node.radius, textColor: e7.textColor, opacity: 0 };
    } };
  }, []), p2 = useTransition(f2, { keys: function(e7) {
    return e7.node.id;
  }, initial: h.update, from: h.enter, enter: h.update, update: h.update, leave: h.leave, config: s2, immediate: !c4 });
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: p2(function(e7, o4) {
    return (0, import_react4.createElement)(d2, { key: o4.node.id, label: o4.label, style: O3({}, e7, { radius: D(e7.radius) }), node: o4.node });
  }) });
};
var J = function(e6) {
  var o4 = e6.node, r4 = e6.label, i4 = e6.style, n4 = zt();
  return (0, import_jsx_runtime3.jsx)(animated.text, { x: i4.x, y: i4.y, textAnchor: "middle", dominantBaseline: "central", style: O3({}, n4.labels.text, { fill: i4.textColor, opacity: i4.opacity, pointerEvents: "none" }), children: r4 }, o4.id);
};
var N2 = ["theme", "isInteractive", "animate", "motionConfig", "renderWrapper"];
var Q = function(e6) {
  var r4 = e6.data, t4 = e6.id, l4 = void 0 === t4 ? V2.id : t4, a2 = e6.value, d2 = void 0 === a2 ? V2.value : a2, u2 = e6.valueFormat, c4 = e6.width, s2 = e6.height, v3 = e6.margin, f2 = e6.padding, b2 = void 0 === f2 ? V2.padding : f2, y3 = e6.leavesOnly, C3 = void 0 === y3 ? V2.leavesOnly : y3, g3 = e6.colors, M3 = void 0 === g3 ? V2.colors : g3, x2 = e6.colorBy, k2 = void 0 === x2 ? V2.colorBy : x2, w2 = e6.inheritColorFromParent, I = void 0 === w2 ? V2.inheritColorFromParent : w2, F3 = e6.childColor, W2 = void 0 === F3 ? V2.childColor : F3, L = e6.borderWidth, R = void 0 === L ? V2.borderWidth : L, O4 = e6.borderColor, P3 = void 0 === O4 ? V2.borderColor : O4, B2 = e6.circleComponent, j3 = void 0 === B2 ? q2 : B2, z4 = e6.defs, H2 = void 0 === z4 ? V2.defs : z4, D2 = e6.fill, N3 = void 0 === D2 ? V2.fill : D2, Q2 = e6.enableLabels, U2 = void 0 === Q2 ? V2.enableLabels : Q2, X2 = e6.label, Y2 = void 0 === X2 ? V2.label : X2, Z2 = e6.labelsFilter, $2 = e6.labelsSkipRadius, _2 = void 0 === $2 ? V2.labelsSkipRadius : $2, ee2 = e6.labelTextColor, oe2 = void 0 === ee2 ? V2.labelTextColor : ee2, re3 = e6.labelComponent, ie2 = void 0 === re3 ? J : re3, ne2 = e6.layers, te2 = void 0 === ne2 ? V2.layers : ne2, le2 = e6.isInteractive, ae2 = e6.onMouseEnter, de = e6.onMouseMove, ue = e6.onMouseLeave, ce = e6.onClick, se = e6.tooltip, ve = void 0 === se ? V2.tooltip : se, fe = e6.zoomedId, he = e6.role, pe = void 0 === he ? V2.role : he, me = wt(c4, s2, v3), be = me.outerWidth, ye = me.outerHeight, Ce2 = me.margin, ge = me.innerWidth, Me2 = me.innerHeight, xe = S({ data: r4, id: l4, value: d2, valueFormat: u2, width: ge, height: Me2, padding: b2, leavesOnly: C3, colors: M3, colorBy: k2, inheritColorFromParent: I, childColor: W2 }), ke2 = T2(xe, fe, ge, Me2), we2 = (0, import_react4.useMemo)(function() {
    return In(H2, ke2, N3, { targetKey: "fill" });
  }, [H2, ke2, N3]), Ie = { circles: null, labels: null };
  te2.includes("circles") && (Ie.circles = (0, import_jsx_runtime3.jsx)(K, { nodes: ke2, borderWidth: R, borderColor: P3, isInteractive: le2, onMouseEnter: ae2, onMouseMove: de, onMouseLeave: ue, onClick: ce, component: j3, tooltip: ve }, "circles")), U2 && te2.includes("labels") && (Ie.labels = (0, import_jsx_runtime3.jsx)(G, { nodes: ke2, label: Y2, filter: Z2, skipRadius: _2, textColor: oe2, component: ie2 }, "labels"));
  var Ee = A2({ nodes: xe });
  return (0, import_jsx_runtime3.jsx)(gn, { width: be, height: ye, margin: Ce2, defs: we2, role: pe, children: te2.map(function(e7, o4) {
    return void 0 !== Ie[e7] ? Ie[e7] : "function" == typeof e7 ? (0, import_jsx_runtime3.jsx)(import_react4.Fragment, { children: (0, import_react4.createElement)(e7, Ee) }, o4) : null;
  }) });
};
var U = function(e6) {
  var o4 = e6.theme, r4 = e6.isInteractive, i4 = void 0 === r4 ? V2.isInteractive : r4, n4 = e6.animate, t4 = void 0 === n4 ? V2.animate : n4, l4 = e6.motionConfig, a2 = void 0 === l4 ? V2.motionConfig : l4, d2 = e6.renderWrapper, u2 = P2(e6, N2);
  return (0, import_jsx_runtime3.jsx)(St, { isInteractive: i4, animate: t4, motionConfig: a2, renderWrapper: d2, theme: o4, children: (0, import_jsx_runtime3.jsx)(Q, O3({ isInteractive: i4 }, u2)) });
};
var X = function(e6) {
  return (0, import_jsx_runtime3.jsx)(It, { children: function(o4) {
    var r4 = o4.width, i4 = o4.height;
    return (0, import_jsx_runtime3.jsx)(U, O3({ width: r4, height: i4 }, e6));
  } });
};
var Y = function(e6, o4) {
  return to([e6, o4], function(e7, o5) {
    return e7 - o5;
  });
};
var Z = function(e6) {
...
var $ = function(e6) {
  var o4, r4, i4 = e6.node, n4 = e6.style, t4 = e6.onMouseEnter, l4 = e6.onMouseMove, a2 = e6.onMouseLeave, d2 = e6.onClick, u2 = Z(n4.radius), c4 = z3(i4, { onMouseEnter: t4, onMouseMove: l4, onMouseLeave: a2, onClick: d2 });
  return (0, import_jsx_runtime3.jsx)(animated.div, { style: { position: "absolute", top: Y(n4.y, n4.radius), left: Y(n4.x, n4.radius), height: u2, width: u2, borderRadius: n4.radius, backgroundColor: n4.color, borderWidth: (o4 = n4.borderWidth, r4 = n4.radius, to([r4], function(e7) {
    return Math.min(o4, e7);
  })), borderStyle: "solid", borderColor: n4.borderColor, boxSizing: "border-box" }, onMouseEnter: c4.onMouseEnter, onMouseMove: c4.onMouseMove, onMouseLeave: c4.onMouseLeave, onClick: c4.onClick });
};
var _ = function(e6) {
  var o4 = e6.node, r4 = e6.label, i4 = e6.style, n4 = zt(), t4 = Z(i4.radius);
  return (0, import_jsx_runtime3.jsx)(animated.div, { style: O3({}, n4.labels.text, { position: "absolute", display: "flex", justifyContent: "center", alignItems: "center", top: Y(i4.y, i4.radius), left: Y(i4.x, i4.radius), width: t4, height: t4, color: i4.textColor, opacity: i4.opacity, pointerEvents: "none" }), children: r4 }, o4.id);
};
var ee = ["theme", "isInteractive", "animate", "motionConfig"];
var oe = function(e6) {
  var o4 = e6.data, r4 = e6.id, t4 = void 0 === r4 ? V2.id : r4, l4 = e6.value, a2 = void 0 === l4 ? V2.value : l4, d2 = e6.valueFormat, u2 = e6.width, c4 = e6.height, s2 = e6.margin, v3 = e6.padding, f2 = void 0 === v3 ? V2.padding : v3, p2 = e6.leavesOnly, m3 = void 0 === p2 ? V2.leavesOnly : p2, b2 = e6.colors, y3 = void 0 === b2 ? V2.colors : b2, C3 = e6.colorBy, g3 = void 0 === C3 ? V2.colorBy : C3, M3 = e6.inheritColorFromParent, x2 = void 0 === M3 ? V2.inheritColorFromParent : M3, k2 = e6.childColor, w2 = void 0 === k2 ? V2.childColor : k2, I = e6.borderWidth, F3 = void 0 === I ? V2.borderWidth : I, W2 = e6.borderColor, L = void 0 === W2 ? V2.borderColor : W2, R = e6.circleComponent, O4 = void 0 === R ? $ : R, P3 = e6.enableLabels, B2 = void 0 === P3 ? V2.enableLabels : P3, j3 = e6.label, z4 = void 0 === j3 ? V2.label : j3, H2 = e6.labelsFilter, D2 = e6.labelsSkipRadius, q3 = void 0 === D2 ? V2.labelsSkipRadius : D2, J2 = e6.labelTextColor, N3 = void 0 === J2 ? V2.labelTextColor : J2, Q2 = e6.labelComponent, U2 = void 0 === Q2 ? _ : Q2, X2 = e6.layers, Y2 = void 0 === X2 ? V2.layers : X2, Z2 = e6.isInteractive, ee2 = e6.onMouseEnter, oe2 = e6.onMouseMove, re3 = e6.onMouseLeave, ie2 = e6.onClick, ne2 = e6.tooltip, te2 = void 0 === ne2 ? V2.tooltip : ne2, le2 = e6.zoomedId, ae2 = e6.role, de = void 0 === ae2 ? V2.role : ae2, ue = wt(u2, c4, s2), ce = ue.outerWidth, se = ue.outerHeight, ve = ue.margin, fe = ue.innerWidth, he = ue.innerHeight, pe = S({ data: o4, id: t4, value: a2, valueFormat: d2, width: fe, height: he, padding: f2, leavesOnly: m3, colors: y3, colorBy: g3, inheritColorFromParent: x2, childColor: w2 }), me = T2(pe, le2, fe, he), be = { circles: null, labels: null };
  Y2.includes("circles") && (be.circles = (0, import_jsx_runtime3.jsx)(K, { nodes: me, borderWidth: F3, borderColor: L, isInteractive: Z2, onMouseEnter: ee2, onMouseMove: oe2, onMouseLeave: re3, onClick: ie2, component: O4, tooltip: te2 }, "circles")), B2 && Y2.includes("labels") && (be.labels = (0, import_jsx_runtime3.jsx)(G, { nodes: me, label: z4, filter: H2, skipRadius: q3, textColor: N3, component: U2 }, "labels"));
  var ye = A2({ nodes: pe });
  return (0, import_jsx_runtime3.jsx)("div", { role: de, style: { position: "relative", overflow: "hidden", width: ce, height: se }, children: (0, import_jsx_runtime3.jsx)("div", { style: { position: "absolute", top: ve.top, left: ve.left }, children: Y2.map(function(e7, o5) {
    return void 0 !== be[e7] ? be[e7] : "function" == typeof e7 ? (0, import_jsx_runtime3.jsx)(import_react4.Fragment, { children: (0, import_react4.createElement)(e7, ye) }, o5) : null;
  }) }) });
};
var re2 = function(e6) {
  var o4 = e6.theme, r4 = e6.isInteractive, i4 = void 0 === r4 ? V2.isInteractive : r4, n4 = e6.animate, t4 = void 0 === n4 ? V2.animate : n4, l4 = e6.motionConfig, a2 = void 0 === l4 ? V2.motionConfig : l4, d2 = P2(e6, ee);
  return (0, import_jsx_runtime3.jsx)(St, { isInteractive: i4, animate: t4, motionConfig: a2, theme: o4, children: (0, import_jsx_runtime3.jsx)(oe, O3({ isInteractive: i4 }, d2)) });
};
var ie = function(e6) {
  return (0, import_jsx_runtime3.jsx)(It, { children: function(o4) {
    var r4 = o4.width, i4 = o4.height;
    return (0, import_jsx_runtime3.jsx)(re2, O3({ width: r4, height: i4 }, e6));
  } });
};
var ne = ["isInteractive", "theme"];
var te = function(e6) {
  var o4 = e6.data, n4 = e6.id, a2 = void 0 === n4 ? V2.id : n4, d2 = e6.value, c4 = void 0 === d2 ? V2.value : d2, s2 = e6.valueFormat, v3 = e6.width, f2 = e6.height, p2 = e6.margin, m3 = e6.padding, b2 = void 0 === m3 ? V2.padding : m3, y3 = e6.leavesOnly, C3 = void 0 === y3 ? V2.leavesOnly : y3, g3 = e6.colors, M3 = void 0 === g3 ? V2.colors : g3, x2 = e6.colorBy, w2 = void 0 === x2 ? V2.colorBy : x2, F3 = e6.inheritColorFromParent, W2 = void 0 === F3 ? V2.inheritColorFromParent : F3, L = e6.childColor, R = void 0 === L ? V2.childColor : L, O4 = e6.borderWidth, P3 = void 0 === O4 ? V2.borderWidth : O4, B2 = e6.borderColor, z4 = void 0 === B2 ? V2.borderColor : B2, A3 = e6.enableLabels, D2 = void 0 === A3 ? V2.enableLabels : A3, K2 = e6.label, q3 = void 0 === K2 ? V2.label : K2, G2 = e6.labelsFilter, J2 = e6.labelsSkipRadius, N3 = void 0 === J2 ? V2.labelsSkipRadius : J2, Q2 = e6.labelTextColor, U2 = void 0 === Q2 ? V2.labelTextColor : Q2, X2 = e6.isInteractive, Y2 = e6.onMouseMove, Z2 = e6.onClick, $2 = e6.tooltip, _2 = void 0 === $2 ? V2.tooltip : $2, ee2 = e6.zoomedId, oe2 = e6.role, re3 = void 0 === oe2 ? V2.role : oe2, ie2 = e6.pixelRatio, ne2 = void 0 === ie2 ? V2.pixelRatio : ie2, te2 = (0, import_react4.useRef)(null), le2 = zt(), ae2 = wt(v3, f2, p2), de = ae2.margin, ue = ae2.innerWidth, ce = ae2.innerHeight, se = ae2.outerWidth, ve = ae2.outerHeight, fe = S({ data: o4, id: a2, value: c4, valueFormat: s2, width: ue, height: ce, padding: b2, leavesOnly: C3, colors: M3, colorBy: w2, inheritColorFromParent: W2, childColor: R }), he = T2(fe, ee2, ue, ce), pe = j2({ nodes: he, label: q3, filter: G2, skipRadius: N3, textColor: U2 }), me = Xe(z4, le2);
  (0, import_react4.useEffect)(function() {
    if (te2.current) {
      te2.current.width = se * ne2, te2.current.height = ve * ne2;
      var e7 = te2.current.getContext("2d");
      e7.scale(ne2, ne2), e7.fillStyle = le2.background, e7.fillRect(0, 0, se, ve), e7.save(), e7.translate(de.left, de.top), he.forEach(function(o5) {
        P3 > 0 && (e7.strokeStyle = me(o5), e7.lineWidth = P3), e7.beginPath(), e7.arc(o5.x, o5.y, o5.radius, 0, 2 * Math.PI), e7.fillStyle = o5.color, e7.fill(), P3 > 0 && e7.stroke();
      }), D2 && (e7.textAlign = "center", e7.textBaseline = "middle", e7.font = le2.labels.text.fontSize + "px " + le2.labels.text.fontFamily, pe.forEach(function(o5) {
        e7.fillStyle = o5.textColor, e7.fillText("" + o5.label, o5.node.x, o5.node.y);
      }));
    }
  }, [te2, ue, ce, se, ve, de.top, de.left, le2, ne2, he, D2, pe, P3, me]);
  var be = H({ nodes: he, canvasEl: te2, margin: de }), ye = k(), Ce2 = ye.showTooltipFromEvent, ge = ye.hideTooltip, Me2 = (0, import_react4.useCallback)(function(e7) {
    var o5 = be(e7);
    o5 ? (null == Y2 || Y2(o5, e7), Ce2((0, import_react4.createElement)(_2, o5), e7)) : ge();
  }, [be, Ce2, _2, ge]), xe = (0, import_react4.useCallback)(function() {
    ge();
  }, [ge]), ke2 = (0, import_react4.useCallback)(function(e7) {
    if (Z2) {
      var o5 = be(e7);
      o5 && Z2(o5, e7);
    }
  }, [be, Z2]);
  return (0, import_jsx_runtime3.jsx)("canvas", { ref: te2, width: se * ne2, height: ve * ne2, style: { width: se, height: ve, cursor: X2 ? "auto" : "normal" }, role: re3, onMouseEnter: X2 ? Me2 : void 0, onMouseMove: X2 ? Me2 : void 0, onMouseLeave: X2 ? xe : void 0, onClick: X2 ? ke2 : void 0 });
};
var le = function(e6) {
  var o4 = e6.isInteractive, r4 = void 0 === o4 ? V2.isInteractive : o4, i4 = e6.theme, n4 = P2(e6, ne);
  return (0, import_jsx_runtime3.jsx)(St, { isInteractive: r4, theme: i4, children: (0, import_jsx_runtime3.jsx)(te, O3({ isInteractive: r4 }, n4)) });
};
var ae = function(e6) {
  return (0, import_jsx_runtime3.jsx)(It, { children: function(o4) {
    var r4 = o4.width, i4 = o4.height;
    return (0, import_jsx_runtime3.jsx)(le, O3({ width: r4, height: i4 }, e6));
  } });
};
export {
  U as CirclePacking,
  le as CirclePackingCanvas,
  re2 as CirclePackingHtml,
  ...
  j2 as useCirclePackingLabels,
  A2 as useCirclePackingLayerContext,
  T2 as useCirclePackingZoom,
  H as useMouseCircleDetection,
  z3 as useNodeMouseHandlers
};
